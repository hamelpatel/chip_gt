...
#module add bioinformatics/plink/1.07
...
plink --noweb --bfile ${bedfile}.plinkQC_before_qc --${my_qc} --out ${bedfile}.plinkQC_before_qc;
done
...
#after
R --vanilla --slave --args bfile=${bedfile}.plinkQC_03_0.95_snp_callrate_removed < plot.missingness.v02_after_QC.r;
...
cat ${bedfile}.plinkQC_03_0.95_snp_callrate_removed.frq | awk '$5>=0.05'> ${bedfile}.plinkQC_03_0.95_snp_callrate_removed_common_snps;
cat ${bedfile}.plinkQC_03_0.95_snp_callrate_removed.frq | awk '$5>=0.05' | sed '1,1d' | awk '{print $2}' > ${bedfile}.plinkQC_03_0.95_snp_callrate_removed_common_snps_list;
cat ${bedfile}.plinkQC_03_0.95_snp_callrate_removed.frq | awk '$5<0.05' | sed '1,1d' | awk '{print $2}' > ${bedfile}.plinkQC_03_0.95_snp_callrate_removed_rare_snps_list;
...
--extract ${bedfile}.plinkQC_03_0.95_snp_callrate_removed.prune.in;
