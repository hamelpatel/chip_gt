...
qsub -q ${queue_name} -N initial-QC -hold_jid report2ped ${exome_chip_bin}/exome.qc.pipeline.v06_rosalind.sh ${working_dir}/${basename}.report_zcall_input ${working_dir}/${basename}.report_zcall_input ${exome_chip_bin} X_Y_XY_MT_chromosome_snps_IDs
...
qsub -q ${queue_name} -N summary_report -hold_jid basic_post_qc ${exome_chip_bin}/create_summary_report_v02_rosalind.sh ${basename} ${multi_mapping_probes}
